    ...
    <div class="row">
        <div class="col-md-12">
            <div class="obuolys-uzrasai-wrapper">
                <div class="uzrasai">
                    <h3>Lorem <br>ipsum dolor<br> sit amet</h3>
                    <p>In bibendum at metus nec aliquam</p>
                    <p class="mygtukas">Duis gravida, metus a ullamcorper!</p>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="facebook">
                <h2 class="biolatte-facebook">Biolatte Facebook</h2>
